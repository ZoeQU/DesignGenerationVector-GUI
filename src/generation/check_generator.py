...
class Check():
    ...
    def _generate_check_pattern(self, img, num, index):
        width = 200
        height = 200
    ...
    def generate_check_pattern(self, img, num):
        for i in range(6):
            savename, self.color_block_path = self._generate_check_pattern(img, num, i)
...
if __name__ == "__main__":
    ...
    check  = Check()
    savename, color_block_path = check.generate_check_pattern(img, num=9)
    print("biu~biu~biu~")
