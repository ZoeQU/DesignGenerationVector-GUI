import sys
from PyQt6.QtWidgets import QApplication, QMainWindow, QLabel, QPushButton, QComboBox, QSlider
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.small_image_label_text.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.big_image_label_text.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.generated_image_label_text.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.generated_image_label_text.setGeometry(0, 0, 380, 380)

        # 创建生成,下载和重新生成按钮
        self.generate_button = QPushButton("Generated", self)
        ...
        self.slider1_label = QLabel("Rotate", self)
        self.slider1_label.move(37, 505)
    ...
    def generate_image(self):
        ...
        pattern = self.keyword_combo.currentText()
        # ...
        # 在这里实现生成图片的功能，根据下拉选项框的值生成不同的图片
        pattern = self.keyword_combo.currentText()
        if pattern == 'motif':
