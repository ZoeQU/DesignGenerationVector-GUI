...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.Hint.setPlainText("Hint: The higher similarity threshold, the more design elements are obtained.") 
        ...
        self.ScrollBarValueLabel.setText("0.45")  # Default text
    ...
    def update_scrollbar_value(self):
        ...
        float_value = value / 10.0 + 0.45
        self.thre = float_value - 0.45
        print(self.thre)
        self.ScrollBarValueLabel.setText(f"{float_value:.2f}")
        # if float_value <= 0.4:
        #     mapped_value = 0.6 + (0.85 - 0.6) * (float_value - 0.1) / (0.4 - 0.1)
        # else:
        #     mapped_value = float_value

        # self.ScrollBarValueLabel.setText(f"{mapped_value:.2f}")
